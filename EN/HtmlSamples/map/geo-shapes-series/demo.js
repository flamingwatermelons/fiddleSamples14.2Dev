         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                series: [{
                    ...
                    shapeDataSource: 'http://dev.igniteui.local/14-2/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://dev.igniteui.local/14-2/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
