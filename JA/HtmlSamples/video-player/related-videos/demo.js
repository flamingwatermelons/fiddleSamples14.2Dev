$(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 560,
                posterUrl: "http://jp.dev.igniteui.local/14-2/images/samples/video-player/quince-intro-1.png",
                fullscreen: false,
                ...
                relatedVideos: [
					{
					    imageUrl: "http://jp.dev.igniteui.local/14-2/images/samples/video-player/quince-intro-2.png",
					    title: "Quince プレゼンテーション パート 1",
