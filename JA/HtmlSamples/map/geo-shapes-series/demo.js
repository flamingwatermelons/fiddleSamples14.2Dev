         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                series: [{
                    ...
                    shapeDataSource: 'http://jp.dev.igniteui.local/14-2/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://jp.dev.igniteui.local/14-2/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
